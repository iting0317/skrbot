...
namespace Skrbot.WebApi.Scorables
{
    // 註冊全域訊息 - 重置對話
    [Serializable]
    public class SkrDialogScorable : ScorableBase<IActivity, string, double>
    {
        ...
        public const string Pattern = "你是誰";

        public SkrDialogScorable(IComponentContext component)
        {
        ...
        {
            await _context.ReplyMessageAsync("本隊伍有：Aaron_Wang, Tim_Wu, Joe_Chang, Kevin_Peng, Reyka_Wang", waitTime: 1000, isSendTyping: true);
        }
